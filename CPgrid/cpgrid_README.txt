...
That the grids are spaced evenly, from 10K to 2500K (rows) and from 1.0GPa to 140.0GPa (columns), with differences of 1.0eN (N=0, for pressure in GPa) and 1.0eM (M=1, for temperature in K) allows easy access and indexing on an as-needed basis. The function Cps_from_grid shows more about the trimming process.
...
#print(modelDBStix.phase_info[0:15])
